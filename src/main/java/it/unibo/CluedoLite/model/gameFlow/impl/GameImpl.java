...
public class GameImpl implements Game {
    ...
    @Override
    public List<CreationCharacterImpl> getAvailableCharacters() { return availableCharacters; }

    @Override
    public void setPlayer(int index, Player player) { players.set(index, player); }
